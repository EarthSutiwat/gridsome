<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="top-0 left-0 z-40 fixed w-full border-t-14 border-blue-300">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/" @click.native="scrollToTop">
            <g-image src="../../static/logo.png" width="60" alt="logo" />
          </g-link>
        ...
        >
          ...
          <li>
            <a v-if="$route.path === '/'" href="/#games" v-scroll-to="{ el: '#games', offset: -25 }" class="text-copy-primary hover:text-gray-600" data-cypress="games">Games</a>
            <g-link v-else to="/#games" class="text-copy-primary hover:text-gray-600">Games</g-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#concept" v-scroll-to="{ el: '#concept', offset: -90 }" class="text-copy-primary hover:text-gray-600" data-cypress="concept">Concept</a>
            <g-link v-else to="/#concept" class="text-copy-primary hover:text-gray-600">Concept</g-link>
          </li>
          <li>
    ...
    <footer class="bg-blue-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="610110476@psu.ac.th" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.youtube.com/channel/UC4ySGZUQ9MfSnOkiclusH8Q" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/EarthSutiwat" target="_blank" class="text-white hover:text-gray-400">
